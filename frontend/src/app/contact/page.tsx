  ...
  return (
    <PublicLayout>
      <div className="container mx-auto px-4 py-20 max-w-4xl min-h-[70vh]">
        <h1 className="text-4xl md:text-5xl font-bold text-[var(--text-primary)] mb-8">Contacto</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          <div className="p-8 rounded-3xl bg-[var(--bg-main)] border border-[var(--border-color)] flex flex-col items-start transition-all hover:-translate-y-1 hover:shadow-lg hover:shadow-blue-500/10">
            <div className="p-3 bg-blue-500/10 text-blue-500 rounded-2xl mb-6">
              <Mail className="w-8 h-8" />
            </div>
            <h3 className="text-2xl font-bold text-[var(--text-primary)] mb-3">Soporte y Negocios</h3>
          ...
          <div className="p-8 rounded-3xl bg-[var(--bg-main)] border border-[var(--border-color)] flex flex-col items-start transition-all hover:-translate-y-1 hover:shadow-lg hover:shadow-purple-500/10">
            <div className="p-3 bg-purple-500/10 text-purple-500 rounded-2xl mb-6">
              <AtSign className="w-8 h-8" />
            </div>
            <h3 className="text-2xl font-bold text-[var(--text-primary)] mb-3">Redes Sociales</h3>
            <p className="text-[var(--text-secondary)] mb-8">
        ...
        <div className="p-8 rounded-3xl bg-[var(--bg-surface)] border border-[var(--border-color)] text-center">
          <div className="inline-flex p-3 bg-[var(--bg-main)] text-[var(--text-secondary)] rounded-full mb-4 shadow-sm border border-[var(--border-color)]">
            <Globe className="w-6 h-6" />
          </div>
          <h3 className="text-xl font-bold text-[var(--text-primary)] mb-2">Oficinas Virtuales</h3>
