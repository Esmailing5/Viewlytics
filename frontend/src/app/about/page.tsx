  ...
  return (
    <PublicLayout>
      <div className="container mx-auto px-4 py-20 max-w-4xl min-h-[70vh]">
        <h1 className="text-4xl md:text-5xl font-bold text-[var(--text-primary)] mb-8">Acerca de {brandConfig.name}</h1>
        <div className="space-y-6 text-lg text-[var(--text-secondary)] leading-relaxed">
          ...
          <h2 className="text-2xl font-bold text-[var(--text-primary)] mt-12 mb-4">Nuestra Visión</h2>
          <p>
