  ...
  return (
    <PublicLayout>
      <div className="container mx-auto px-4 py-20 max-w-4xl min-h-[70vh]">
        <h1 className="text-4xl md:text-5xl font-bold text-[var(--text-primary)] mb-8">Política de Privacidad</h1>
        <div className="space-y-6 text-[var(--text-secondary)] leading-relaxed">
          <p className="text-sm">Última actualización: {new Date().toLocaleDateString('es-ES')}</p>
          
          <h2 className="text-2xl font-bold text-[var(--text-primary)] mt-8 mb-4">1. Recopilación de Información</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[var(--text-primary)] mt-8 mb-4">2. Uso de la Información</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[var(--text-primary)] mt-8 mb-4">3. Cookies y Tecnologías de Seguimiento</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[var(--text-primary)] mt-8 mb-4">4. Compartir Datos con Terceros</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[var(--text-primary)] mt-8 mb-4">5. Seguridad de los Datos</h2>
          <p>
