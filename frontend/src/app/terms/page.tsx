  ...
  return (
    <PublicLayout>
      <div className="container mx-auto px-4 py-20 max-w-4xl min-h-[70vh]">
        <h1 className="text-4xl md:text-5xl font-bold text-[var(--text-primary)] mb-8">Términos de Servicio</h1>
        <div className="space-y-6 text-[var(--text-secondary)] leading-relaxed">
          <p className="text-sm">Última actualización: {new Date().toLocaleDateString('es-ES')}</p>

          <h2 className="text-2xl font-bold text-[var(--text-primary)] mt-8 mb-4">1. Aceptación de los Términos</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[var(--text-primary)] mt-8 mb-4">2. Naturaleza y Precisión de los Datos</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[var(--text-primary)] mt-8 mb-4">3. Uso Aceptable</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[var(--text-primary)] mt-8 mb-4">4. Propiedad Intelectual e Imagen</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold text-[var(--text-primary)] mt-8 mb-4">5. Modificaciones del Servicio</h2>
          <p>
