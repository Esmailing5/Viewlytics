/**
 * Viewlytics — SocialIcons
 *
 * Íconos SVG inline para plataformas sociales.
 * Usados como alternativa a lucide-react cuando los íconos de redes sociales
 * no están disponibles en la versión instalada.
 *
 * Todos los íconos son componentes React puros con props de className.
 */
