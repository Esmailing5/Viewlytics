...
export function renderTopRankingPreview() {
  return `
    <div class="tr-preview" id="tr-preview">
      ...
      <div class="safe-zone-wrapper" style="transform: scale(0.99); transform-origin: center center; flex: 1; display: flex; flex-direction: column; width: 100%; height: 100%; z-index: 2;">
        <div class="tr-header">
          <div class="tr-title-group">
            ...
            <div class="tr-title" id="prev-tr-title"></div>
          </div>
          <div class="tr-meta">
        ...
        <div class="tr-content">
          <div class="tr-list" id="prev-tr-list">
...
export function initTopRankingPreview() {
  const render = (state) => {
    ...
    const itemsToRender = tr.items.slice(0, 10);
    ...
    const previewWrapper = document.getElementById('tr-preview');
